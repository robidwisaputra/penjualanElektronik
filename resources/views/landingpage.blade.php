...
<head>
	...
	<!-- Favicon icon -->
	<link rel="icon" href="{{asset('landingpage')}}\logos\favicon.ico" type="image/png" sizes="16x16">
	<!-- Bootstrap -->
	...
	<div class="wrapper animsition" data-animsition-in-class="fade-in" data-animsition-in-duration="1000" data-animsition-out-class="fade-out" data-animsition-out-duration="1000">
		<div class="container">
			 <nav class="navbar navbar-expand-lg navbar-light navbar-default navbar-fixed-top" role="navigation">
				<div class="container">
					<a class="navbar-brand page-scroll" href="#main"><img src="{{asset('landingpage')}}\logos\logo.png" alt="adminity Logo"></a>
					...
					<div class="collapse navbar-collapse" id="navbarSupportedContent">
						...
						<a class="btn btn-primary btn-action" data-wow-delay="0.2s" href="{{url('login')}}"><i class="icofont icofont-user-alt-3"></i> Sign In</a>
					</div>
				</div>
			</nav>
		</div>
		<div class="main" id="main">
						...
						<div class="row justify-content-md-center">
							...
							<div class="col-md-12">
								<div class="hero-image">
									<img class="img-fluid" src="{{asset('landingpage')}}\images\logo.jpg" alt="">
								</div>
							</div>
						</div>
					</div>
								...
								<div class="row">
									<div class="col-sm-4 wow fadeInUp" data-wow-delay="0.2s">
										<div class="services-icon">
											<img src="{{asset('landingpage')}}\logos\icon1.png" height="60" width="60" alt="Service">
										</div>
									...
									<div class="col-sm-4 wow fadeInUp" data-wow-delay="0.3s">
										<div class="services-icon">
											<img class="icon-2" src="{{asset('landingpage')}}\logos\icon2.png" height="60" width="60" alt="Service">
										</div>
										<div class="services-description">
									...
									<div class="col-sm-4 wow fadeInUp" data-wow-delay="0.4s">
										<div class="services-icon">
											<img class="icon-3" src="{{asset('landingpage')}}\logos\icon3.png" height="60" width="60" alt="Service">
										</div>
										<div class="services-description">
					...
					<div class="flex-split">
						<div class="f-left wow fadeInUp" data-wow-delay="0s">
							<div class="left-content">
								<img class="img-fluid" src="{{asset('landingpage')}}\images\feature_1.png" alt="">
							</div>
						</div>
					...
					<div class="flex-split">
						...
						<div class="f-left">
							<div class="left-content wow fadeInUp" data-wow-delay="0.3s">
								<img class="img-fluid" src="{{asset('landingpage')}}\images\feature_2.png" alt="">
							</div>
						</div>
					</div>
				</div>
					...
					<div class="row text-center">
						<div class="col-md-12">
							<div class="testimonials owl-carousel owl-theme">
								<div class="testimonial-single"><img class="img-circle" src="{{asset('landingpage')}}\images\testimonial2.jpg" alt="Client Testimonoal">
								...
								<div class="testimonial-single"><img class="img-circle" src="{{asset('landingpage')}}\images\testimonial1.jpg" alt="Client Testimonoal">
								...
								<div class="testimonial-single"><img class="img-circle" src="{{asset('landingpage')}}\images\testimonial3.jpg" alt="Client Testimonoal">
									<div class="testimonial-text">
			...
			<div class="feature_huge text-center">
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							<img class="img-fluid wow fadeInUp" data-wow-delay="0.1s" src="{{asset('landingpage')}}\images\big_feature.png" alt="" style="max-width:100%">
						</div>
						<div class="col-md-12 feature_list">
							<div class="row">
								<div class="col-sm-4 wow fadeInUp" data-wow-delay="0.2s">
									<img src="{{asset('landingpage')}}\logos\feature_icon.png" alt="Feature">
								...
								<div class="col-sm-4 wow fadeInUp" data-wow-delay="0.4s">
									<img src="{{asset('landingpage')}}\logos\feature_icon_2.png" alt="Feature">
								...
								<div class="col-sm-4 wow fadeInUp" data-wow-delay="0.6s">
									<img src="{{asset('landingpage')}}\logos\feature_icon_3.png" alt="Feature">
							...
							<div class="row">
								<div class="col-sm-6">
									<div class="table-left wow fadeInUp" data-wow-delay="0.4s">
										<div class="icon">
											<img src="{{asset('landingpage')}}\logos\cart2.png" alt="Icon">
										</div>
								...
								<div class="col-sm-6 ">
									<div class="table-right wow fadeInUp" data-wow-delay="0.6s">
										<div class="icon">
											<img src="{{asset('landingpage')}}\logos\cart1.png" alt="Icon">
										</div>
										<div class="pricing-details">
											<h2>Premium Plan</h2>
											<span>$19.99</span>
			...
			<div class="client-section">
				<div class="container text-center">
					<div class="clients owl-carousel owl-theme">
						<div class="single">
							<img src="{{asset('landingpage')}}\logos\logo1.png" alt="">
						</div>
						<div class="single">
							<img src="{{asset('landingpage')}}\logos\logo2.png" alt="">
						</div>
						<div class="single">
							<img src="{{asset('landingpage')}}\logos\logo3.png" alt="">
						</div>
						<div class="single">
							<img src="{{asset('landingpage')}}\logos\logo4.png" alt="">
						</div>
						<div class="single">
							<img src="{{asset('landingpage')}}\logos\logo6.png" alt="">
						</div>
						<div class="single">
							<img src="{{asset('landingpage')}}\logos\logo7.png" alt="">
						</div>
					</div>
				</div>
			</div>
			...
			<div class="cta-sub text-center no-color">
				<div class="container">
					...
					<div class="form wow fadeInUp" data-wow-delay="0.3s">
						<form class="subscribe-form wow zoomIn" action="{{asset('landingpage')}}/php/subscribe.php" method="post" accept-charset="UTF-8" enctype="application/x-www-form-urlencoded" autocomplete="off" novalidate="">
			...
			<div class="footer">
				<div class="container">
					<div class="col-md-12 text-center">
						<img src="{{asset('landingpage')}}\logos\logo.png" alt="Adminty Logo">
